...
public class Balisong : WhiteFlameRelicTemplate
{
    public override RelicRarity Rarity => RelicRarity.Starter;

    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<LyticFactorPower>(1m)];
    ...
    public override async Task AfterDamageGiven(PlayerChoiceContext choiceContext, Creature? dealer, DamageResult result, ValueProp props, Creature target, CardModel? cardSource)
    {
        ...
        {
            Flash();
            await PowerCmd.Apply<LyticFactorPower>(choiceContext, target, 1m, Owner.Creature, null);
        }
    }
}
